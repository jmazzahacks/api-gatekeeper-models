...
class Client:
    ...
    Attributes:
        ...
        legacy_key_id: Optional non-UUID alternate identifier for a client.
            Exists so legacy HMAC callers that predate the UUID contract
            (e.g. mobile apps built against rba-auth-service) can still be
            resolved by a string alias. New clients should leave this None.
            Semantics of when/whether it is used for lookup are owned by the
            consuming service.
    """
    client_name: str
    status: ClientStatus
    ...
    def from_dict(cls, data: dict) -> 'Client':
        ...
        return cls(
            ...
            legacy_key_id=data.get('legacy_key_id')
        )
    ...
    def create_new(
        ...
        Args:
            ...
            legacy_key_id: Optional non-UUID identifier for legacy HMAC callers
